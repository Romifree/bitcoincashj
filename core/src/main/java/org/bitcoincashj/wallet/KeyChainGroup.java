...
import org.bitcoincashj.wallet.listeners.CurrentAddressChangeEventListener;
...
public class KeyChainGroup implements KeyBag {
    ...
    public static class Builder {
         ...
         * chain. This behaviour will likely be changed with bitcoincashj 0.16 such that only a P2WPKH chain is created and
         * activated.</p>
         *
