...
public class Context {
    ...
    public Context(NetworkParameters params, int eventHorizon, Coin feePerKb, boolean ensureMinRequiredFee) {
        log.info("Creating bitcoincashj {} context.", VersionMessage.bitcoincashj_VERSION);
    ...
    /**
     * Returns the current context that is associated with the <b>calling thread</b>. bitcoincashj is an API that has thread
     ...
     * want to create core bitcoincashj objects. Generally, if a class can accept a Context in its constructor and might
