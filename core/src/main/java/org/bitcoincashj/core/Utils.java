 ...
 * To enable debug logging from the library, run with -Dbitcoincashj.logging=true on your command line.
 */
public class Utils {
     ...
     * forces bitcoincashj to try to allocate a huge piece of the memory resulting in OutOfMemoryError.
     */
