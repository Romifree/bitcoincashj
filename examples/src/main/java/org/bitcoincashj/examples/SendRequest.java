...
public class SendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Have a look at the code of the SendRequest class to see what's happening and what other options you have: https://bitcoincashj.github.io/javadoc/0.11/com/google/bitcoin/core/Wallet.SendRequest.html
        // 
        ...
        try {
            ...
            // bitcoincashj allows you to define a BalanceFuture to execute a callback once your wallet has a certain balance.
            // Here we wait until the we have enough balance and display a notice.
            // bitcoincashj is using the ListenableFutures of the Guava library. Have a look here for more information: https://github.com/google/guava/wiki/ListenableFutureExplained
